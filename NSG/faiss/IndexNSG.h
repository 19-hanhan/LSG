...
struct IndexNSG : Index {
    ...
    explicit IndexNSG(int d = 0, int R = 32, MetricType metric = METRIC_L2); //默认使用L2距离
    ...
    void Indegree_sta(int n);

    // 传入NICDM参数
    void set_nicdm_distance(float* x, float y=1.0);
};
