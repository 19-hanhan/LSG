...
METRIC_NICDM = _swigfaiss.METRIC_NICDM
...
class Index(object):
    ...
    def set_nicdm_distance(self, x, y):
        return _swigfaiss.Index_set_nicdm_distance(self, x, y)
...
class IndexFlat(Index):
    ...
    def set_nicdm_distance(self, x, y=1.0):
        return _swigfaiss.IndexFlat_set_nicdm_distance(self, x, y)
...
class HNSW(object):
    ...
    def shink_reverse_neighbors_2(self, new_neibor, dis, cur):
        return _swigfaiss.HNSW_shink_reverse_neighbors_2(self, new_neibor, dis, cur)
    ...
    def search_from_candidate_unbounded_to_gt(self, node, qdis, ef, vt, stats, gt_idx):
        return _swigfaiss.HNSW_search_from_candidate_unbounded_to_gt(self, node, qdis, ef, vt, stats, gt_idx)

    def search(self, qdis, k, I, D, vt):
        return _swigfaiss.HNSW_search(self, qdis, k, I, D, vt)

    def search_gt(self, qdis, k, I, D, vt, i):
        return _swigfaiss.HNSW_search_gt(self, qdis, k, I, D, vt, i)
    ...
    def search_from_candidate_unbounded_train_binary_datasets(self, node, qdis, I, D, k, gt_idx, vt):
        return _swigfaiss.HNSW_search_from_candidate_unbounded_train_binary_datasets(self, node, qdis, I, D, k, gt_idx, vt)
...
class IndexHNSW(Index):
    ...
    def prund(self, n):
        return _swigfaiss.IndexHNSW_prund(self, n)
...
class NSG(object):
    ...
    def search_enhence_with_hubs(self, dis, k, I, D, vt, xb_size):
        return _swigfaiss.NSG_search_enhence_with_hubs(self, dis, k, I, D, vt, xb_size)
    ...
    def find_hot_hubs_enhence(self, hot_hubs, n, ratios):
        return _swigfaiss.NSG_find_hot_hubs_enhence(self, hot_hubs, n, ratios)

    def find_hot_hubs(self, ses, n, ratios):
        return _swigfaiss.NSG_find_hot_hubs(self, ses, n, ratios)

    def hot_hubs_new_neighbors(self, ses, hot_hubs, n):
        return _swigfaiss.NSG_hot_hubs_new_neighbors(self, ses, hot_hubs, n)

    def add_new_reverse_link_end_enhence(self, hot_hubs, n, nb_reverse_neighbors):
        return _swigfaiss.NSG_add_new_reverse_link_end_enhence(self, hot_hubs, n, nb_reverse_neighbors)
...
class IndexNSG(Index):
    ...
    def search_enhence_with_hubs(self, n, x, k, distances, labels, xb_size):
        return _swigfaiss.IndexNSG_search_enhence_with_hubs(self, n, x, k, distances, labels, xb_size)

    def combine_index_with_hot_hubs_enhence(self, n, len_ratios, ht_hbs_ratios, nb_nbors_per_level):
        return _swigfaiss.IndexNSG_combine_index_with_hot_hubs_enhence(self, n, len_ratios, ht_hbs_ratios, nb_nbors_per_level)
    ...
    def Indegree_sta(self, n):
        return _swigfaiss.IndexNSG_Indegree_sta(self, n)

    def set_nicdm_distance(self, x, y=1.0):
        return _swigfaiss.IndexNSG_set_nicdm_distance(self, x, y)
...
class DistanceComputer(object):
    ...
    def set_query_idx(self, x, idx):
        return _swigfaiss.DistanceComputer_set_query_idx(self, x, idx)
