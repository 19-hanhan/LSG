...
class IndexHNSW(Index):
    ...
    def set_local_scaling(self, enable):
        return _swigfaiss.IndexHNSW_set_local_scaling(self, enable)

    def set_neighbor_radius(self, list):
        return _swigfaiss.IndexHNSW_set_neighbor_radius(self, list)

    def set_ls_alpha(self, alpha):
        return _swigfaiss.IndexHNSW_set_ls_alpha(self, alpha)
